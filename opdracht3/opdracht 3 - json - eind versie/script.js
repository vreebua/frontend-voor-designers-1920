...
function showData(jsonObj) {
    ...
    var genres = randomFilm.genres;
    var listItem = document.createElement('li');
    listItem.textContent = genres;
    ...
    var releaseDate = randomFilm.release_date;
    var listItem = document.createElement('li');
    listItem.textContent = releaseDate;
    ...
    var reviews = randomFilm.reviews;
    ...
    simpleplotbutton.textContent = "Short plot about the movie (key press)";

    var simple = randomFilm.simple_plot;
    var listItem = document.createElement('li');
    listItem.textContent = simple;
    ...
    plotbutton.textContent = "Long plot about the movie (key up)";

    var plot = randomFilm.plot;
    var listItem = document.createElement('li');
    listItem.textContent = plot;
    ...
    var directors = randomFilm.directors;
